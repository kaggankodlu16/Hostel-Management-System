...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(https://cdn.pixabay.com/photo/2013/09/23/04/36/hostel-185156__340.jpg);">
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									<label id="f" for="" class="text-uppercase text-sm">Your Username or Email</label>
									<input  id="l" type="text" placeholder="Username" name="username" class="form-control mb">
									<label id="f"for="" class="text-uppercase text-sm">Password</label>
									<input  id="l" type="password" placeholder="Password" name="password" class="form-control mb">
